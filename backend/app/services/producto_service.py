...
class ProductoService:
    ...
    def create(data: dict, usuario_id: int) -> int:
        ...
        if ProductoDAO.exist_producto(nombre=data['nombre'], id_categoria=data['id_categoria'], id_localidad=localidad['id_localidad'], id_lugar=data['id_lugar']):
            raise Exception(f"Ya existe un producto con el nombre '{data['nombre']}' en la categoría seleccionada aumente el stock o use otro nombre")
    ...
    def update(producto_id: int, data: dict, usuario_id: int) -> bool:
        ...
        if success:
                ...
                #         'descripcioon': producto_actual['descripcion'],
                #         'id_categoria': producto_actual['id_categoria'],
                #         'costo': producto_actual['costo'],
                #         'unidad_medida':producto_actual['stock_minimo'],
                #         'activo':producto_actual['activo']
                #     },
                #     'datos_nuevos': data ,
                #     'id_usuario': usuario_id,
                #     'user_agent': username,
